...
public class FollowViewModel extends AndroidViewModel {
    private MutableLiveData<List<FollowResponse>> userListLiveData = new MutableLiveData<>();
    ...
    public MutableLiveData<List<FollowResponse>> getUserListLiveData() {
    ...
    public void setMessageLiveData(MutableLiveData<String> messageLiveData) {
        this.messageLiveData = messageLiveData;
    }

    public void getFollowerByUserId(Long userId, int page, int size) {
        compositeDisposable.add(api.getFollowerByUserId(userId ,page, size)
                ...
                .subscribe(
                        response -> {
                            ...
                            if (response.getStatus() == 200 && response.getResult() != null) {
                                userListLiveData.setValue(response.getResult());
    ...
    public void getFollowingByUserId(Long userId, int page, int size) {
        compositeDisposable.add(api.getFollowingByUserId(userId ,page, size)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                        response -> {
