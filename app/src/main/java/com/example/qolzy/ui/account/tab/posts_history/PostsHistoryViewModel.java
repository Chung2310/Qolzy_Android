...
public class PostsHistoryViewModel extends AndroidViewModel {
    ...
    public PostsHistoryViewModel(@NonNull Application application) {
        super(application);
    ...
    public void getPostsHistoryByUserId(Long userId, int page, int size){
        compositeDisposable.add(api.getPostsHistory(userId,page,size)
